...
model Reactor_Losses_Gangue
  ...
  SolarTherm.Models.Fluid.Pumps.PumpSimple Ore_pump(redeclare package Medium = SolarTherm.Media.SolidParticles.IOE_Dehydroxylated_ph) annotation(
  ...
  SolarTherm.Models.Reactors.Reactor_H2DRI_Overall_Losses_Gangue Reactor annotation(
