...
model HBSTES_Case1_ComponentLevel
  ...
  parameter Real f_TES_oversize = 4.0;
  ...
  parameter SI.CoefficientOfHeatTransfer U_loss_top = 10.0*(373.15-298.15)/(T_max-298.15) "Heat loss coefficient at the top of the tank (W/m2K)";
  parameter SI.CoefficientOfHeatTransfer U_loss_bot = 10.0*(373.15-298.15)/(T_max-298.15) "Heat loss coefficient at the bottom of the tank (W/m2K)";
...
end HBSTES_Case1_ComponentLevel;