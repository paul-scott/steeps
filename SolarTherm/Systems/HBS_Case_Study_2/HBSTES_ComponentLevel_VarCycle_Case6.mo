within SolarTherm.Systems.HBS_Case_Study_2;

model HBSTES_ComponentLevel_VarCycle_Case6 "This component analysis allows a variable cycle length depending on t_storage and t_standby"
...
end HBSTES_ComponentLevel_VarCycle_Case6;