...
model HBSTES_ComponentLevel_VarCycle_Case2 "This component analysis allows a variable cycle length depending on t_storage and t_standby"
...
end HBSTES_ComponentLevel_VarCycle_Case2;