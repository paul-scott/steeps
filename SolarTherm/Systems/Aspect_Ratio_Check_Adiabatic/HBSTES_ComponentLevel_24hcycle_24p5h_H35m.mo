...
model HBSTES_ComponentLevel_24hcycle_24p5h_H35m
  ...
  parameter SI.Time t_discharge = 7.0 * 3600.0 "Rated discharging period (s)";
...
end HBSTES_ComponentLevel_24hcycle_24p5h_H35m;