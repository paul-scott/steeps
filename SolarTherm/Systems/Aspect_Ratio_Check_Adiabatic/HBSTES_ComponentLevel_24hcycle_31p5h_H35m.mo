...
model HBSTES_ComponentLevel_24hcycle_31p5h_H35m
  ...
  parameter SI.Time t_discharge = 9.0 * 3600.0 "Rated discharging period (s)";
...
end HBSTES_ComponentLevel_24hcycle_31p5h_H35m;