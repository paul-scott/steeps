...
model HBSTES_ComponentLevel_VarCycle_14h_ar4p8
...
//Connectors
  ...
  annotation(
    experiment(StopTime = 432000, StartTime = 0, Tolerance = 1e-4, Interval = 30),
...
end HBSTES_ComponentLevel_VarCycle_14h_ar4p8;