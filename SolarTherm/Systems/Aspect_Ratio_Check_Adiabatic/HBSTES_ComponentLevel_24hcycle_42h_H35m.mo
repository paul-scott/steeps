...
model HBSTES_ComponentLevel_24hcycle_42h_H35m
  ...
  parameter Real ar = 4.8;//6.187*((4.0*3600.0)/t_discharge)^0.5 "Tank H/D ratio (m)";
...
end HBSTES_ComponentLevel_24hcycle_42h_H35m;