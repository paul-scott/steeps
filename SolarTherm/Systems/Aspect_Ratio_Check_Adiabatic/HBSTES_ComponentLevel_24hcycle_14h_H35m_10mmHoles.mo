...
model HBSTES_ComponentLevel_24hcycle_14h_H35m_10mmHoles
  ...
  parameter SI.Length d_p = 0.01 "Hole diameter in the filler (m)";
...
end HBSTES_ComponentLevel_24hcycle_14h_H35m_10mmHoles;